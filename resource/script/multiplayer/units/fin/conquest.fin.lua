	...
	{Repeat = 0, --infinite
		Units = {
			...
			-- Infantry
				...
				{priority = 1.0, type = {"Infantry", "Squad",}, unit = "squad_military_police_early_con(fin)"},
				{priority = 1.0, type = {"Infantry", "Squad",}, unit = "squad_fortress_rifle_early_con(fin)"},
				...
				{priority = 0.5, type = {"Infantry", "Squad",}, unit = "squad_penal_mid_con(fin)"},
				...
				{priority = 1.0, type = {"Infantry", "Squad", "AT",}, unit = "squad_arm_jag_late_mot_con(fin)"},
				...
				{priority = 1.0, type = {"Infantry", "Squad",}, unit = "squad_hrr_cav_late_con(fin)"},
				...
				{priority = 1.0, type = {"Infantry", "Squad",}, unit = "squad_jag_strike_late_con(fin)"},

				{priority = 1.0, type = {"Infantry", "Squad",}, unit = "squad_urr_cav_mid_con(fin)"},
				{priority = 1.0, type = {"Infantry", "Squad",}, unit = "squad_urr_cav_late_con(fin)"},

				{priority = 1.0, type = {"Infantry", "Squad",}, unit = "squad_hq_lr_jag_mid_con(fin)"},
				{priority = 1.0, type = {"Infantry", "Squad",}, unit = "squad_hq_lr_jag_late_con(fin)"},
			...
			-- Cannons
				...
				{priority = 0.5, type = {"Cannon", "Artillery",}, unit = "155mm_k17"},
				{priority = 0.1, type = {"Cannon", "Artillery",}, unit = "203mm_h17"},
				{priority = 0.1, type = {"Cannon", "Artillery",}, unit = "210mm_h17"},
				--Rocket Artillery
