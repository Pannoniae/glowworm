	...
	{Repeat = 0,  --infinite
		Units = {
			...
			-- Doctrine Point Units
				...
				--  All-round Doctrine
					---[[
					{priority = 1.0, type = {"Class3", "Doctrine", "Tier1", "Armored", "MG",}, unit = "doctrine_ba20_late"},
					{priority = 1.0, type = {"Class2", "Doctrine", "Tier1", "Tank", "Light",}, unit = "doctrine_t60_late"},
					{priority = 1.0, type = {"Class1", "Doctrine", "Tier1", "Tank", "Light",}, unit = "doctrine_t70m"},

					--{priority = 1.0, type = {"Class", "Doctrine", "Tier2", "Infantry",}, unit = "doctrine_squad_rus_signaller_late(rus)"},
					{priority = 1.0, type = {"Class2", "Doctrine", "Tier2", "Tank", "Light", "Artillery",}, unit = "doctrine_t60_bm8_24_late"},
					{priority = 1.0, type = {"Class2", "Doctrine", "Tier2", "Tank", "Heavy",}, unit = "doctrine_kv85"},

					{priority = 1.0, type = {"Class2", "Doctrine", "Tier3", "Cannon", "Artillery",}, unit = "doctrine_122mm_a19_late"},
					{priority = 1.0, type = {"Class1", "Doctrine", "Tier3", "Tank", "Heavy", "AT",}, unit = "doctrine_isu152"},
					{priority = 1.0, type = {"Class1", "Doctrine", "Tier3", "Tank", "Heavy",}, unit = "doctrine_is2"},
					--]]

				--  Defensive Doctrine
					---[[
					--{priority = 1.0, type = {"Class", "Doctrine", "Tier1", "Infantry",}, unit = "doctrine_squad_sapper_motorised_late(rus)"},
					{priority = 1.0, type = {"Class3", "Doctrine", "Tier1", "Cannon", "AA",}, unit = "doctrine_37mm_61k_late"},
					{priority = 1.0, type = {"Class2", "Doctrine", "Tier1", "Cannon", "Support",}, unit = "doctrine_76mm_m43"},

					{priority = 1.0, type = {"Class2", "Doctrine", "Tier2", "Cannon", "Mortar",}, unit = "doctrine_120mm_pm38_late"},
					{priority = 1.0, type = {"Class2", "Doctrine", "Tier2", "Vehicle", "Artillery",}, unit = "doctrine_zis6_bm8_48_late"},
				...
				--  Irregular Doctrine
					---[[
					{priority = 1.0, type = {"Class2", "Doctrine", "Tier1", "Infantry",}, unit = "doctrine_squad_heavyrecon(rus)"},
					{priority = 1.0, type = {"Class3", "Doctrine", "Tier1", "Vehicle", "MG", "Infantry", "Team",}, unit = "doctrine_m72_snipers_late"},
					{priority = 1.0, type = {"Class1", "Doctrine", "Tier1", "Cannon", "MG",}, unit = "doctrine_dshk_late"},

					--{priority = 1.0, type = {"Class", "Doctrine", "Tier2", "Plane", "Airstrike",}, unit = "doctrine_yak1_late"},
					{priority = 1.0, type = {"Class2", "Doctrine", "Tier2", "Tank", "Medium",}, unit = "doctrine_t3457_43"},
					{priority = 1.0, type = {"Class2", "Doctrine", "Tier2", "Tank", "Medium",}, unit = "doctrine_ot34_late"},
				...
				--  Lend-Lease Doctrine
					---[[
					{priority = 1.0, type = {"Class2", "Doctrine", "Tier1", "Tank", "Light",}, unit = "doctrine_m3a1_stuart_rus"},
					{priority = 1.0, type = {"Class1", "Doctrine", "Tier1", "Tank", "Light",}, unit = "doctrine_valentine7"},
					{priority = 1.0, type = {"Class3", "Doctrine", "Tier1", "Infantry",}, unit = "doctrine_squad_scoutcar_marines"},

					{priority = 1.0, type = {"Class2", "Doctrine", "Tier2", "Tank", "Medium",}, unit = "doctrine_m4a2_75_late_rus"},
					{priority = 1.0, type = {"Class2", "Doctrine", "Tier2", "Tank", "Heavy",}, unit = "doctrine_churchill3_valentine9"},
					{priority = 1.0, type = {"Class3", "Doctrine", "Tier2", "Cannon", "Artillery",}, unit = "doctrine_107mm_m1910_30_late"},

					{priority = 1.0, type = {"Class1", "Doctrine", "Tier3", "Tank", "Medium",}, unit = "doctrine_2m4a2_76_rus"},
					{priority = 1.0, type = {"Class2", "Doctrine", "Tier3", "Vehicle", "Artillery",}, unit = "doctrine_bm31"},
					{priority = 1.0, type = {"Class1", "Doctrine", "Tier3", "Cannon", "AT",}, unit = "doctrine_100mm_bs3_scoutcar"},
					--]]

				--  Support Doctrine
					---[[
					--{priority = 1.0, type = {"Class", "Doctrine", "Tier1", "Infantry", "Team",}, unit = "doctrine_squad_rus_politicalofficer_late(rus)"},
