	...
	{Repeat = 0, --infinite
		Units = {
			...
			-- Infantry
				...
				--T1+
				{priority = 1.0, type = {"Infantry", "Squad",}, unit = "squad_vet_partisan_rifle_late_con(rus)"},
				{priority = 1.0, type = {"Infantry", "Squad",}, unit = "squad_vet_partisan_smg_late_con(rus)"},
				...
				{priority = 1.0, type = {"Infantry", "Squad",}, unit = "squad_nkvd_rifle_con(rus)"},
				...
				--T3+
				{priority = 1.0, type = {"Infantry", "Squad",}, unit = "squad_elite_guardsrifle_44_motor_con(rus)"},
				{priority = 1.0, type = {"Infantry", "Squad",}, unit = "squad_elite_guards_smg_mg_44_motor_con(rus)"},
				{priority = 1.0, type = {"Infantry", "Squad",}, unit = "squad_guards_cav_44_con(rus)"},
				{priority = 1.0, type = {"Infantry", "Squad",}, unit = "squad_guards_marines_44_con(rus)"},

				--T4
				{priority = 1.0, type = {"Infantry", "Squad",}, unit = "squad_nkvd_mountain_cav_con(rus)"},
				{priority = 1.0, type = {"Infantry", "Squad",}, unit = "squad_mountain_cav_44_con(rus)"},
				...
				{priority = 1.0, type = {"Infantry", "Squad", "AT",}, unit = "squad_assaultsappers_at_con(rus)"},
				...
				--T4+
				{priority = 1.5, type = {"Infantry", "Squad",}, unit = "squad_guards_paras_con(rus)"},
