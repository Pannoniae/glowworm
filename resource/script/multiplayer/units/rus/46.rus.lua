	...
	{Repeat = 0,  --infinite
		Units = {
			...
			-- Infantry Squads
				...
				{priority = 1.0, type = {"Class2", "Infantry", "Squad",}, unit = "squad_recon_late(rus)"},
				{priority = 1.0, type = {"Class2", "Infantry", "Squad",}, unit = "squad_rifleunit(rus)"},
				{priority = 1.0, type = {"Class2", "Infantry", "Squad",}, unit = "squad_assault_rifle(rus)"},
				{priority = 1.0, type = {"Class2", "Infantry", "Squad",}, unit = "squad_heavy_rifleunit(rus)"},
				{priority = 1.0, type = {"Class1", "Infantry", "Squad",}, unit = "squad_smg(rus)"},
				{priority = 1.0, type = {"Class3", "Infantry", "Squad", "AT",}, unit = "squad_at_rifle(rus)"},
				--{priority = 1.0, type = {"Class1", "Infantry", "Squad",}, unit = "squad_guardsrifle(rus)"},
				--{priority = 1.0, type = {"Class1", "Infantry", "Squad",}, unit = "squad_guards_smg_heavy(rus)"},
				--{priority = 1.0, type = {"Class1", "Infantry", "Squad",}, unit = "squad_marines_late(rus)"},
				{priority = 1.0, type = {"Class1", "Infantry", "Squad",}, unit = "squad_assault_shock_rifle_squad(rus)"},
				{priority = 1.0, type = {"Class1", "Infantry", "Squad",}, unit = "squad_assault_shock_squad(rus)"},
				{priority = 1.0, type = {"Class1", "Infantry", "Squad",}, unit = "squad_assault_eng_late_irr(rus)"},
			...
			-- Doctrine Point Units
				...
				--  All-round Doctrine
					...
					--{priority = 1.0, type = {"Class", "Infantry",}, unit = "doctrine_squad_rus_signaller_late(rus)"},
				...
				--  Defensive Doctrine
					---[[
					--{priority = 1.0, type = {"Class", "Infantry",}, unit = "doctrine_squad_sapper_motorised_late(rus)"},
				...
				--  Irregular Doctrine
					---[[
					--{priority = 1.0, type = {"Class2", "Infantry",}, unit = "doctrine_squad_heavyrecon(rus)"},
					--{priority = 1.0, type = {"Class3", "Vehicle", "MG", "Infantry", "Team",}, unit = "doctrine_m72_snipers_late"},
					{priority = 1.0, type = {"Class1", "Cannon", "MG",}, unit = "dshk_aa"},

					--{priority = 1.0, type = {"Class", "Plane", "Airstrike",}, unit = "doctrine_yak1_late"},
					{priority = 1.0, type = {"Class2", "Tank", "Medium",}, unit = "t3457_43"},
					{priority = 1.0, type = {"Class2", "Tank", "Medium",}, unit = "t3476_43_flame"},

					--{priority = 1.0, type = {"Class", "Plane", "Airstrike",}, unit = "doctrine_il2_late"},
					--{priority = 1.0, type = {"Class2", "Vehicle", "Artillery",}, unit = "doctrine_zis6_bm13_16_late"},
				...
				--  Lend-Lease Doctrine
					---[[
					{priority = 1.0, type = {"Class2", "Tank", "Light",}, unit = "m3a1_stuart_rus"},
					{priority = 1.0, type = {"Class1", "Tank", "Light",}, unit = "valentine7"},
					--{priority = 1.0, type = {"Class3", "Infantry",}, unit = "doctrine_squad_scoutcar_marines"},

					--{priority = 1.0, type = {"Class2", "Tank", "Medium",}, unit = "m4a2_75_late_rus"},
					--{priority = 1.0, type = {"Class2", "Tank", "Heavy",}, unit = "doctrine_churchill3_valentine9"},
					{priority = 1.0, type = {"Class3", "Cannon", "Artillery",}, unit = "107mm_m1910_30"},

					--{priority = 1.0, type = {"Class1", "Tank", "Medium",}, unit = "m4a2_76w_late_rus"},
				...
				--  Support Doctrine
					---[[
					--{priority = 1.0, type = {"Class", "Infantry", "Team",}, unit = "doctrine_squad_rus_politicalofficer_late(rus)"},
					{priority = 1.0, type = {"Class3", "Tank", "Light", "Support",}, unit = "bt7a"},
					{priority = 1.0, type = {"Class2", "Tank", "Light",}, unit = "t50"},

					--{priority = 1.0, type = {"Class", "Plane", "Recon",}, unit = "doctrine_po2_late"},
