	...
	{Repeat = 0,  --infinite
		Units = {
			...
			-- Wheeled vehicles
				...
				{priority = 1.0, type = {"Class3", "Vehicle", "MG",}, unit = "bmw_r71_mg42"},
				{priority = 1.0, type = {"Class3", "Vehicle", "MG",}, unit = "kubelwagen_mg"},
				{priority = 1.0, type = {"Class3", "Vehicle", "MG",}, unit = "kubelwagen_mg42"},
			...
			-- Doctrine Point Units
				...
				--  All-round Doctrine
					---[[
					--{priority = 1.0, type = {"Class3", "Infantry",}, unit = "doctrine_squad_volksgrenadieredetach(ger)"},
					{priority = 1.0, type = {"Class2", "Armored", "AA",}, unit = "sdkfz234_1"},
					{priority = 1.0, type = {"Class1", "Armored", "AA",}, unit = "sdkfz234_2"},

					--{priority = 1.0, type = {"Class", "Infantry",}, unit = "doctrine_squad_ger_signaller_late(ger)"},
					...
					{priority = 1.0, type = {"Class2", "Armored", "Artillery",}, unit = "sdkfz251d_1_stuka_ss"},
					{priority = 1.0, type = {"Class1", "Tank", "Medium", "AT",}, unit = "jagdpanther"},
					--]]

				--  Defensive Doctrine
					---[[
					--{priority = 1.0, type = {"Class", "Vehicle", "Unarmed", "Support", "Engineer",}, unit = "doctrine_kettenkrad_goliath_late"},
					{priority = 1.0, type = {"Class2", "Cannon", "AA",}, unit = "37mm_flak37"},
					--{priority = 1.0, type = {"Class1", "Cannon", "Support",}, unit = "doctrine_75mm_legebig18_late"},
					...
					{priority = 1.0, type = {"Class1", "Tank", "Heavy", "AT",}, unit = "ferdinand_ss"},
					--]]

				--  Irregular Doctrine
					---[[
					--{priority = 1.0, type = {"Class3", "Infantry",}, unit = "doctrine_squad_brandenburger_late(ger)"},
					{priority = 1.0, type = {"Class2", "Tank", "Light",}, unit = "panzer1f"},
					{priority = 1.0, type = {"Class1", "Tank", "Medium",}, unit = "panzer3_flamm"},

					--{priority = 1.0, type = {"Class", "Plane", "Airstrike",}, unit = "doctrine_bf109_late"},
					{priority = 1.0, type = {"Class1", "Cannon", "Support",}, unit = "150mm_sig33_late"},
					{priority = 1.0, type = {"Class2", "Tank", "Medium",}, unit = "panzer4j"},

					--{priority = 1.0, type = {"Class", "Plane", "Airstrike",}, unit = "doctrine_bf110_late"},
				...
				--  Offensive Doctrine
					...
					--{priority = 1.0, type = {"Class3", "Infantry", "Tank", "Medium", "AT",}, unit = "doctrine_sturmartillerie_unit"},
				...
				--  Support Doctrine
					---[[
					--{priority = 1.0, type = {"Class", "Infantry", "Team",}, unit = "doctrine_squad_ger_officer_lw_late(ger)"},
					...
					--{priority = 1.0, type = {"Class", "Plane", "Recon",}, unit = "doctrine_fi156_late"},
				...
				--  All-Round 2 (WEST) Doctrine
					...
					--{priority = 1.0, type = {"Class", "Infantry",}, unit = "doctrine_squad_ger_signaller_2_late(ger)"},
					...
					{priority = 1.0, type = {"Class1", "Tank", "Heavy",}, unit = "tiger2p"},
					--]]
			--]====]
		}
	}
